...
<nav class="navbar navbar-expand-sm navbar-dark" style= 'background-color: #1A2E35;'>
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
  	<img src="<?= base_url('assets/logo-2.jpg') ?>" alt="logo" width=50 height=50 >
   	...
   	<a class="nav-item nav-link" href="#" style= 'color: #FFFFFF;  margin-left: 10px'>Booking <span class="sr-only">(current)</span></a>
   	<a class="nav-item nav-link" href="#" style= 'color: #FFFFFF;  margin-left: 10px'>Cari Jadwal</a>
  </div>
